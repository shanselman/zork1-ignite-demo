...
?L12:	EQUAL? PRSA,V?MUNG,V?ATTACK \?L15
	...
	CALL JIGS-UP,STR?3 >STACK
	RSTACK
?L16:	PRINTR "Suicide is not the answer."
...
?L11:	CALL PICK-ONE,DUMMY >STACK
	...
	PRINTR "The boards are securely fastened."
...
?L20:	PRINTR "There is no granite wall here."
	...
	PRINTR "The songbird is not here but is probably nearby."
...
?L13:	PRINTR "what appears to be a kitchen."
...
?L5:	EQUAL? PRSA,V?MUNG,V?ATTACK \?L8
	...
	PRINTR "How can you attack a spirit with material objects?"
...
?L11:	PRINTR "The heat from the bell is too intense."
...
?L17:	EQUAL? PRSA,V?RING \FALSE
	PRINTR "The bell is too hot to reach."

	.FUNCT BOARDED-WINDOW-FCN
	EQUAL? PRSA,V?OPEN \?L1
	PRINTR "The windows are boarded and can't be opened."
?L1:	EQUAL? PRSA,V?MUNG \FALSE
	PRINTR "You can't break the windows open."

	.FUNCT NAILS-PSEUDO
	EQUAL? PRSA,V?TAKE \FALSE
	PRINTR "The nails, deeply imbedded in the door, cannot be removed."
...
?L11:	CALL FINISH >STACK
	...
	PRINTR "The trophy case is securely fastened to the wall."
...
?L12:	EQUAL? PRSA,V?TAKE \?L20
	PRINTR "The rug is extremely heavy and cannot be carried."
...
?L27:	PRINTR "I suppose you think it's a magic carpet?"
	...
	PRINTI "The "
	PRINTD V
	PRINTR " swings it out of your reach."
?L4:	PRINTI "The "
	PRINTD W
...
?L61:	RANDOM 100 >STACK
	GRTR? 20,STACK \?L64
	EQUAL? PRSO,KNIFE,SWORD,AXE \?L68
	CALL REMOVE-CAREFULLY,PRSO
	...
	SET 'TROLL-FLAG,1
	RETURN TROLL-FLAG
?L64:	EQUAL? PRSO,KNIFE,SWORD,AXE \?L68
	MOVE PRSO,HERE
	...
	FSET TROLL,FIGHTBIT
	RTRUE
?L68:	PRINTI " and not having the most discriminating tastes, gleefully eats it."
	CRLF
	CALL REMOVE-CAREFULLY,PRSO >STACK
	RSTACK
?L47:	EQUAL? PRSA,V?MOVE,V?TAKE \?L74
	PRINTR "The troll spits in your face, grunting ""Better luck next time"" in a rather barbarous accent."
?L74:	EQUAL? PRSA,V?MUNG \FALSE
	PRINTR "The troll laughs at your puny gesture."
?L44:	EQUAL? PRSA,V?LISTEN \?L81
	PRINTR "Every so often the troll says something, probably uncomplimentary, in his guttural tongue."
?L81:	ZERO? TROLL-FLAG /FALSE
...
?L12:	EQUAL? PRSA,V?PICK \?L23
	PRINTR "You can't pick the lock."
...
?L5:	EQUAL? PRSA,V?LAMP-OFF \FALSE
	...
	PRINTR "You nearly burn your hand trying to extinguish the flame."
...
?L1:	EQUAL? PRSA,V?PUT,V?OPEN,V?TAKE \?L5
	...
	PRINTR "The chests are so rusty and corroded that they crumble when you touch them."
...
?L44:	PRINTR "The cyclops is not so stupid as to eat THAT!"
?L27:	EQUAL? PRSA,V?MUNG,V?ATTACK,V?THROW \?L50
	CALL QUEUE,I-CYCLOPS,-1 >STACK
	PUT STACK,0,1
	EQUAL? PRSA,V?MUNG \?L51
	PRINTR """Do you think I'm as stupid as my father was?"", he says, dodging."
...
?L61:	EQUAL? PRSA,V?TIE \?L64
	PRINTR "You cannot tie the cyclops, though he is fit to be tied."
...
?L99:	CALL INT,I-THIEF >STACK
	...
	PRINTR "Sadly for you, the robber collapsed on top of the bag. Trying to take it would wake him."
?L3:	PRINTR "The bag will be taken over his dead body."
...
?L1:	EQUAL? PRSA,V?BURN \?L5
	PRINTR "You cannot burn this door."
?L5:	EQUAL? PRSA,V?MUNG \?L8
	PRINTR "You can't seem to damage the door."
...
?L24:	PRINTR "is turned off."
	...
	PRINTR "It is securely anchored."
...
?L8:	PRINTR "Can you walk on water vapor?"
...
?L7:	FSET? PRSO,BURNBIT \?L10
	...
	PRINTI "The "
	PRINTD PRSO
	PRINTR " floats for a moment, then sinks."
?L10:	CALL REMOVE-CAREFULLY,PRSO
	PRINTI "The "
	PRINTD PRSO
	PRINTR " splashes into the water and is gone forever."
...
?L68:	EQUAL? PRSA,V?DEFLATE \FALSE
	...
	PRINTR "You can't deflate the boat while you're in it."
...
?L7:	EQUAL? PRSI,HANDS \?L10
	PRINTR "I doubt you could do that without damaging it."
...
?L1:	EQUAL? RARG,M-BEG \FALSE
	...
	EQUAL? PRSA,V?PUT \?L1
	EQUAL? PRSO,ME \?L1
?L3:	PRINTR "That would be very unwise. Perhaps even fatal."
...
?L27:	PRINTI "The "
	PRINTD PRSO
	PRINTR " struggles and you cannot tie him up."
...
?L11:	PRINTR "All such attacks are vain in your condition."
?L10:	EQUAL? PRSA,V?EAT,V?CLOSE,V?OPEN /?L15
	EQUAL? PRSA,V?DEFLATE,V?INFLATE,V?DRINK /?L15
	EQUAL? PRSA,V?TIE,V?BURN,V?TURN /?L15
	EQUAL? PRSA,V?RUB,V?UNTIE \?L14
?L15:	PRINTR "Even such an action is beyond your capabilities."
?L14:	EQUAL? PRSA,V?WAIT \?L18
	PRINTR "Might as well. You've got an eternity."
?L18:	EQUAL? PRSA,V?LAMP-ON \?L21
	PRINTR "You need no light to guide you."
?L21:	EQUAL? PRSA,V?SCORE \?L24
	PRINTR "You're dead! How can you think of your score?"
?L24:	EQUAL? PRSA,V?RUB,V?TAKE \?L27
	PRINTR "Your hand passes through its object."
?L27:	EQUAL? PRSA,V?INVENTORY,V?THROW,V?DROP \?L30
	PRINTR "You have no possessions."
?L30:	EQUAL? PRSA,V?DIAGNOSE \?L33
	PRINTR "You are dead."
?L33:	EQUAL? PRSA,V?LOOK \?L36
	PRINTI "The room looks strange and unearthly"
	FIRST? HERE >STACK /?L39
	PRINTI "."
	JUMP ?L43
?L39:	PRINTI " and objects appear indistinct."
?L43:	CRLF
	FSET? HERE,ONBIT /?L46
...
?L46:	CRLF
	RFALSE
?L36:	EQUAL? PRSA,V?PRAY \?L51
	EQUAL? HERE,SOUTH-TEMPLE \?L52
	FCLEAR LAMP,INVISIBLE
	PUTP WINNER,P?ACTION,0
	SET 'ALWAYS-LIT,0
	SET 'DEAD,0
	IN? TROLL,TROLL-ROOM \?L54
	SET 'TROLL-FLAG,0
?L54:	PRINTI "From the distance the sound of a lone trumpet is heard. The room becomes very bright and you feel disembodied. In a moment, the brightness fades and you find yourself rising as if from a long sleep, deep in the woods. In the distance you can faintly hear a songbird and the sounds of the forest."
	CRLF
	CRLF
	CALL GOTO,FOREST-1 >STACK
	RSTACK
?L52:	PRINTR "Your prayers are not heard."
?L51:	PRINTI "You can't even do that."
	CRLF
	SET 'P-CONT,0
	RETURN 2
...
?L1:	EQUAL? PRSA,V?CROSS \FALSE
	...
	EQUAL? PRSA,V?PUT \?L1
	EQUAL? PRSO,ME \?L1
?L3:	PRINTR "You look before leaping, and realize that you would never survive."
...
?L14:	RANDOM L >STACK
	...
	CALL STUPID-CONTAINER,BAG-OF-COINS,STR?47 >STACK
	RSTACK

	.FUNCT TRUNK-F
	CALL STUPID-CONTAINER,TRUNK,STR?48 >STACK
	RSTACK
